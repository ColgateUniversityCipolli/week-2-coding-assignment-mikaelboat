...
\hlcom{# trapezoidal rule is equivalent to the 1/2 scale of the sum of the left and right areas}
\hldef{left.area} \hlkwb{<-} \hlkwd{sum}\hldef{(delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(left.points)))}
\hldef{right.area} \hlkwb{<-} \hlkwd{sum}\hldef{(delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(right.points)))}
\hldef{(trap.area} \hlkwb{<-} \hldef{(}\hlnum{1} \hlopt{/} \hlnum{2}\hldef{)} \hlopt{*} \hldef{(left.area} \hlopt{+} \hldef{right.area))}
\end{alltt}
\begin{verbatim}
## [1] 8.6664
\end{verbatim}
...
\hldef{riemann.sums} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{fnct}\hldef{,}                        \hlcom{# function to integrate}
  ...
  \hlcom{######################################}
  \hldef{delta.x} \hlkwb{<-} \hldef{(b}\hlopt{-}\hldef{a)}\hlopt{/}\hldef{n.rect}
  \hldef{left.points} \hlkwb{<-} \hldef{a} \hlopt{+} \hlnum{0}\hlopt{:}\hldef{(n.rect} \hlopt{-} \hlnum{1}\hldef{)}\hlopt{*}\hldef{(delta.x)}
  ...
  \hldef{\}}\hlkwa{else if}\hldef{(method} \hlopt{==} \hlsng{"Trapezoidial"}\hldef{)\{}
    \hldef{left.area} \hlkwb{<-} \hlkwd{sum}\hldef{(delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(left.points)))}
    \hldef{right.area} \hlkwb{<-} \hlkwd{sum}\hldef{(delta.x}\hlopt{*}\hldef{(}\hlkwd{integrand}\hldef{(right.points)))}
    \hldef{area} \hlkwb{<-} \hldef{(}\hlnum{1} \hlopt{/} \hlnum{2}\hldef{)} \hlopt{*} \hldef{(left.area} \hlopt{+} \hldef{right.area)}
